defmodule OpenAI.ClientTest do
  ...
  describe "new/1" do
    test "creates a new client from application config" do
      Application.put_env(:openai, :api_key, "some-api-key")
      Application.put_env(:openai, :organization, "some-organization")
    ...
    test "raises when missing :api_key" do
      Application.put_env(:openai, :api_key, nil)
      Application.put_env(:openai, :organization, "some-organization")
    ...
    test "raises when missing :organization" do
      Application.put_env(:openai, :api_key, "some-api-key")
      Application.put_env(:openai, :organization, nil)
